...
namespace WebTinTuc.Areas.Admin.Controllers
{
    public class TaiKhoanController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult Create(TaiKhoans taiKhoans)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(TaiKhoans taiKhoans, string MatKhauMoi, string MatKhauCu)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Delete(int id, TaiKhoans taiKhoans)
        {


            try
            {
                var dbEntity = db.TaiKhoans.Find(id);
            ...
            //try
            //{
            //    TaiKhoans dbEntity = db.TaiKhoans.Find(id);
            //    db.TaiKhoans.Remove(dbEntity);
            //    db.SaveChanges();
            //    TempData["Done"] = "Xóa tài khoản thành công";
